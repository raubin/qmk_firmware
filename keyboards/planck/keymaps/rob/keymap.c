...
// Default values defined elsewhere and are integers
enum planck_layers {
  _QWERTY,
  _COLEMAK,
  _DVORAK,
...
// Control key when held, quote when tapped
#define CTL_TB LCTL_T(KC_TAB)
...
/* Qwerty
 * ,-----------------------------------------------------------------------------------.
 * |Ctl/Tb|   Q  |   W  |   E  |   R  |   T  |   Y  |   U  |   I  |   O  |   P  | Bksp |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | L3   |   A  |   S  |   D  |   F  |   G  |   H  |   J  |   K  |   L  |   ;  |  '   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  | Enter|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Browsr| Ctrl | Alt  | GUI  |Lower |    Space    |Raise |  SCRN  | Down | Up | Brwsr|
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    CTL_TB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_BSPC,
 ...
 * | Tab  | Vol+ | Vol- |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Esc  | Prev | Play | Next |      |      | Left | Down |  Up  | Right|      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | Shift|      |      |      |      |      |      |      |      |      |      |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_LAYER_3] = LAYOUT_planck_grid(
    _______, KC_VOLD, KC_VOLU, _______, _______, _______, _______, BST_SCRN, BST_LFT, BST_RT, BST_FULL, KC_DEL,
